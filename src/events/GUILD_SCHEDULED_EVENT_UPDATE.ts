...
export interface GuildScheduledEventUpdateData {
...
export class GuildScheduledEventUpdateEventData {
  constructor(public data: GuildScheduledEventUpdateData) {}
