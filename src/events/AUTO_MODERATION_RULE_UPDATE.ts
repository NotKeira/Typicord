...
export interface AutoModerationRuleUpdateData {
  /** The id of the rule */
  id: string;
  /** The guild ID */
  guild_id: string;
...
export class AutoModerationRuleUpdateEventData {
  constructor(public data: AutoModerationRuleUpdateData) {}
  ...
  /**
   * The guild ID where the rule was updated
   */
  get guildId() {
