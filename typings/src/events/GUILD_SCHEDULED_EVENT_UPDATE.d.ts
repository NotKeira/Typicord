...
export declare class GuildScheduledEventUpdateData {
    data: GuildScheduledEventUpdateEventData;
    constructor(data: GuildScheduledEventUpdateEventData);
    /**
     * The scheduled event ID
     */
    get id(): string;
    /**
     * The guild ID where the event was updated
     */
    get guildId(): string;
    /**
