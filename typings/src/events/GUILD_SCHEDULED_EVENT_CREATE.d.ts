...
export declare class GuildScheduledEventCreateData {
    data: GuildScheduledEventCreateEventData;
    constructor(data: GuildScheduledEventCreateEventData);
    /**
     * The scheduled event ID
     */
    get id(): string;
    /**
     * The guild ID where the event was created
     */
    get guildId(): string;
    /**
     * The channel ID where the event will be hosted
     */
    ...
    /**
     * Whether this is a stage channel event
     */
    get isStageChannelEvent(): boolean;
    /**
     * Whether this is a voice channel event
     */
    get isVoiceChannelEvent(): boolean;
    /**
     * Whether this is an external event
     */
